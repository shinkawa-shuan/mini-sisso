...
#         regressor = RegressorClass(recipes, executor, y_fit, self.n_term, self.k, self.alpha)
...
# model.py (Corrected argument order for Regressor call)
import pandas as pd
from sklearn.base import BaseEstimator, RegressorMixin
...
# Note: Regressor classes are now imported inside fit()
...
class MiniSisso(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        # ★★★ CRITICAL CORRECTION: Pass arguments in the correct order ★★★
